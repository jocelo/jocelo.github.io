...
export class CertificationsComponent implements OnInit {
  ...
  constructor() {
    this.certs = [{
      ...
      site: 'HackerRank',
      certLink: 'https://www.hackerrank.com/certificates/378b5a403412',
      certImage: 'https://res.cloudinary.com/mycollections/image/upload/v1641680326/certificates/hr_javascript_basic.png'
    }, {
